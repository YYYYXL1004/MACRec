#!/bin/bash
# Games 全流程: LLaMA+concat+CAQ (协同锚定)
# GPU 4,5 双卡 (RQVAE单卡用4, T5双卡用4,5)
# 用法: screen -dmS games_llama bash run_games_llama_concat_caq.sh
...
CHECKPOINT_DIR="/data/yaoxianglin/ETEGRec/MACRec/.pipeline_games_llama_concat"
mkdir -p $CHECKPOINT_DIR

cd /data/yaoxianglin/ETEGRec/MACRec

echo "============================================"
echo " Games LLaMA+concat+CAQ 全流程"
...
echo ""
echo "============================================"
echo " Games LLaMA+concat+CAQ 全流程完成！$(date)"
echo "============================================"
