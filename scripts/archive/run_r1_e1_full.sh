#!/bin/bash
# Round 1 E1 全流程: ST baseline (无collab, 无CAQ)
# GPU 2,3 双卡 DDP
# 用法: screen -dmS r1_e6 bash run_r1_e6_full.sh
...
CHECKPOINT_DIR="/data/yaoxianglin/ETEGRec/MACRec/.pipeline_r1_e1"
mkdir -p $CHECKPOINT_DIR

cd /data/yaoxianglin/ETEGRec/MACRec

echo "============================================"
echo " E1 全流程: ${EXP_NAME}"
echo " 开始时间: $(date)"
echo "============================================"
