#!/bin/bash
# MACRec Arts 全流程复现脚本 (带断点续跑)
# 每步完成后写标记文件，重新运行时自动跳过已完成的步骤
...
# 标记文件目录
CHECKPOINT_DIR="/data/yaoxianglin/ETEGRec/MACRec/.pipeline_checkpoints"
