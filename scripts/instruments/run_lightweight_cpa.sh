#!/bin/bash
# 轻量 CPA 实验: Instruments 数据集
# 使用 E1 (ST+concat+CAQ) 的 RQVAE codes
# 对比两组 cpa_weight: 0.005 和 0.01, 均使用 cosine loss
# 用法: screen -dmS lcpa bash run_lightweight_cpa.sh
...
# ================================================================
# 实验 1: cpa_weight=0.005, cosine loss
# ================================================================
CPA_W=0.005
CPA_LOSS=cosine
...
# 实验2 已拆分到 run_lcpa_w001.sh 并行运行
echo ""
echo "============================================"
echo " 实验1完成！$(date)"
echo " 实验2 在 screen lcpa2 中并行运行"
echo "============================================"
