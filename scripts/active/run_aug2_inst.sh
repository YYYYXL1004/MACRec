#!/bin/bash
# 序列增强实验2: Instruments E1, item_dropout=0.1 + crop_prob=0.3
# 双卡 DDP GPU 0,1 (与 aug1 共享)
# 用法: screen -dmS aug2 bash scripts/active/run_aug2_inst.sh
...
echo " aug_item_dropout=0.1, aug_crop_prob=0.3"
